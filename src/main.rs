...
fn main() {
    ...
    eprintln!("{} {} {}", IMAGE_HEIGHT, IMAGE_WIDTH, ASPECT_RATIO as u32);
...
fn ray_color(ray: &Ray) -> Color {
    if intersect_sphere(&Point3::new(0.0, 0.0, -1.0), 0.5, ray) {
...
fn intersect_sphere(center: &Point3, radius: f32, ray: &Ray) -> bool {
