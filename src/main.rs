...
use crate::{
    ...
    types::{camera::Camera, hittable::Hittable, rtweekend::PI},
};
...
use types::{
    ...
    ray::Ray,
    rtweekend::{random_in_hemisphere, random_in_unit_sphere},
    vector::Point3,
    vector::Vec3,
};
...
const CAMERA_POS: Point3 = Point3 {
    x: -2.0,
    y: 2.0,
    z: 1.0,
};
const CAMERA_FOCUS: Point3 = Point3 {
    x: 0.0,
    y: 0.0,
    z: -1.0,
};
...
fn main() {
    ...
    eprintln!(
        "{} {} {}",
        material_ground.albedo.x, material_ground.albedo.y, material_ground.albedo.z
    );
    eprintln!("Start");
